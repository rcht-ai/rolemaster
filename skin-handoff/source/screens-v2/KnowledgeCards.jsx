  ...
  return (
    <div style={{ width: '100%', maxWidth: 560 }}>
      ...
      <div key={idx} style={{
        ...
        <div style={{ fontSize: 11, fontWeight: 600, color: 'var(--cop-border)', textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: 8 }}>
          {cards[idx]?.kicker}
        </div>
        <h3 style={{ fontSize: 17, fontWeight: 700, color: 'var(--navy-ink)', margin: '0 0 8px', letterSpacing: '-0.01em' }}>
          {cards[idx]?.title}
        </h3>
